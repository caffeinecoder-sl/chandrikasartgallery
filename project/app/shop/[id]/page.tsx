  ...
  if (error || !product) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-6">
        ...
        <h1 className="text-2xl font-light text-white mb-3">{error || 'Product not found'}</h1>
        <p className="text-white/40 mb-8">The artwork you are looking for is unavailable.</p>
        <Link href="/shop" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black rounded-full font-medium hover:bg-white/90 transition-all">
          Back to Collection
        </Link>
      </div>
    );
